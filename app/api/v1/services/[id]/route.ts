 ...
 * Retrieves a service offering by ID within the caller's business.
...
export async function GET(
  ...
  try {
    ...
    const service = await serviceCatalogService.getService(businessId, id);
 ...
 * Updates a service offering within the caller's business.
...
export async function PATCH(
  ...
  try {
    ...
    const updated = await serviceCatalogService.updateService(member, id, body);
 ...
 * Deletes a service offering within the caller's business.
 * Authorized for OWNER and MANAGER roles.
 */
export async function DELETE(
  ...
  try {
    ...
    const result = await serviceCatalogService.deleteService(member, id);
